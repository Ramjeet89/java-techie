...
public class PaymentController {
 ...
 @Autowired
  ...
  /*
    ...
    @PostMapping("/pay")
    public String payNow(@RequestBody PaymentRequest
                                 request) {
        String response = "";
        if
        (request.getPaymentMethod().equals("Paytm")) {
...
*/
    ...
    @PostMapping("/pay")
    public String paymentProcess(@Valid @RequestBody PaymentRequest request) {
        String response = "";
